...
public class CreateUserAdminTest extends BaseClass {
...
/*	@Test(priority=2,dependsOnMethods="loginToApplication")
	...
	@Test(priority=2,dependsOnMethods="loginToApplication")
	public void createUserFromAdminApplication() throws InterruptedException
	{
	  ...
	  logger.info("createUserFromAdmin");
		
	}
	
	/*@Test(priority=3,dependsOnMethods="loginToApplication")
	public void clickUserFromAdminApplication() throws InterruptedException
	{
		logger=report.createTest("create Admin");
	
	    adminPage.createUser();
		adminPage.selectContactsByName("fiona.grace");
		adminPage.selectContactsByName("jasmine.morgan");
		
		
  logger.info("Admin user created / done");

...
public class Utility {
	...
	/*
	 * 1- Screenshot- which will return path 
	 * 2- Handle Sync 
	 * 3- Highlight element
	 * 4 Lib which will handle alert,frame,window with Explicit Wait
	 * 5 DateTimeUtility 6- Assertion Lib 7- Title, url with Assertion using
...
//it can be list of calender,Web Table,Autosuggestive list
